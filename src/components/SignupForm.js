...
function SignupForm() {
    ...
    const [credential, setCredential] = useState({ studentName: "", studentEnrollNo: "",studentPassword:"",facultyName:"",facultyID:"",facultyPassword:"",adminUsername:"",adminPassword:"" });
        ...
        <div>
            ...
            <div className="container px-5 py-24 mx-auto">
                <div className="flex flex-wrap justify-center">
                    <div className="xl:w-1/4 md:w-1/2 p-4">
                        <button className="flex-shrink-0 text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg mt-10 sm:mt-0" onClick={() => { setForm(0) }}>Sign Up as Student</button>
                    </div>
                    <div className="xl:w-1/4 md:w-1/2 p-4">
                        <button className="flex-shrink-0 text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg mt-10 sm:mt-0" onClick={() => { setForm(1) }}>Sign Up as Faculty</button>
                    </div>
                    <div className="xl:w-1/4 md:w-1/2 p-4">
                        <button className="flex-shrink-0 text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg mt-10 sm:mt-0" onClick={() => { setForm(2) }}>Sign Up as Admin</button>
                    </div>
                </div>
            </div>
            ...
            <div hidden={form === 0 ? false : true}>
                ...
                <div className="lg:w-2/6 lg:m-auto md:w-1/2 md:m-auto bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
                    ...
                    <div className="relative mb-4">
                        ...
                        <input onChange={changeCred} value={credential.studentName}  type="text" id="studentName" name="name" className="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                    </div>
                    {/* //Enroll No */}
                    <div className="relative mb-4">
                    ...
                    <button onClick={studentSubmit} className="text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Sign Up</button>
                </div>
            </div>
            ...
            <div hidden={form === 1 ? false : true}>
                <div className="lg:w-2/6 lg:m-auto md:w-1/2 md:m-auto bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
                    ...
                    <div className="relative mb-4">
                        ...
                        <input onChange={changeCred} value={credential.facultyName} type="text" id="facultyName" name="full-name" className="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                    </div>
                    ...
                    <button onClick={facultySubmit} className="text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Sign Up</button>
                </div>
            </div>
            ...
            <div hidden={form === 2 ? false : true}>
                <div className="lg:w-2/6 lg:m-auto md:w-1/2 md:m-auto bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
                    ...
                    <button onClick={adminSubmit} className="text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Sign Up</button>
                </div>
            </div>
            <ToastContainer/>
        </div>
